...
# training sets
train_datasets = [
    dict(**_base_.dataset_train1, pipeline=train_pipeline),
    dict(**_base_.dataset_train2, pipeline=train_pipeline),
    dict(**_base_.dataset_train3, pipeline=train_pipeline),
    dict(**_base_.dataset_train4, pipeline=train_pipeline),
]
train_dataloaders = [
    dict(
...
val_datasets = [
    dict(**_base_.dataset_val1, pipeline=val_pipeline),
    dict(**_base_.dataset_val2, pipeline=val_pipeline),
    dict(**_base_.dataset_val3, pipeline=val_pipeline),
    dict(**_base_.dataset_val4, pipeline=val_pipeline),
]
val_dataloaders = [
    dict(
...
############################################ Evaluators ##############################################
val_evaluators = [
    {{_base_.evaluator_val1}},
    {{_base_.evaluator_val2}},
    {{_base_.evaluator_val3}},
    {{_base_.evaluator_val4}},
]
