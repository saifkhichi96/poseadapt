...
# Modifications: Updated trainer script from MMPose to use
# ContinualLearningRunner when needed.
...
from poseadapt import ContinualLearningRunner
...
def main():
    ...
    is_continual = cfg.get("train_cfg", {}).get("type") == "ContinualTrainingLoop"
    runner_cls = ContinualLearningRunner if is_continual else Runner
    runner = runner_cls.from_cfg(cfg)
